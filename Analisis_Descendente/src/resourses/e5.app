...
/* Definimos el entorno en el que se va a ejeccutar la máquina de Moore. */
environment env;

/* Salidas del sistema, estarán asociadas a los estados. */
...
/* movimientos_pj:
    Maquina de estados para controlar los movimientos del jugador.
*/
