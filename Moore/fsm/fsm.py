...
class Moore(object):
    ...
    def add_state(self, state):
        ...
        print('Añadido estado: ' + state.get_state_id())
    ...
    def set_initial(self, state):
        ...
        print('Estado inicial asignado a: ' + init_state.get_state_id())
    ...
    def set_transition(self, transition_trigger, state1, state2):
        ...
        if state_id_1 in state_id_list and state_id_2 in state_id_list:
            ...
            print('La transición ' + transition_trigger + ' añadida')
        ...
        if not self.initial or not self.curState:
            ...
            for transition in list_transitions:
                if transition[0] == command:
                    ...
                    self.curState.run(command, *args, **kwargs)

                    tracer += (' he cambiado a ' + self.curState.get_state_id())
                    print(tracer)
                    break
